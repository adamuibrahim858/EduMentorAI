@php
    ...
    $isOnSettings      = request()->routeIs('settings*');
...
>
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-6 space-y-1.5">
        ...
        <a 
            ...
            class="{{ $baseClasses }} {{ $isOnNotifications ? $activeClasses : $inactiveClasses }}"
            title="Notifications"
        >
            <svg class="size-5 shrink-0 transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a 
            ...
            class="{{ $baseClasses }} {{ $isOnSettings ? $activeClasses : $inactiveClasses }}"
            title="Settings"
        >
            <svg class="size-5 shrink-0 transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
